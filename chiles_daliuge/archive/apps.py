"""
chiles_daliuge appComponent module.

This is the module of chiles_daliuge containing DALiuGE application components.
...
# @param[in] param/appclass Application Class/chiles_daliuge.MyApp/String/readonly/
