"""
chiles_daliuge component module.

This is the module of chiles_daliuge containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/chiles_daliuge.MyData/String/readonly/
